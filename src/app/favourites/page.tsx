...
const FavouritesPage = () => {
  ...
  // Format price with discount handling
  const formatPrice = (price: number, discountPercentage?: number): string => {
    return discountPercentage
      ? (price * (1 - discountPercentage / 100)).toFixed(2)
      : price.toFixed(2);
  };

  // Add product to the cart (for future implementation)
      ...
      <div className="md:mx-auto py-20 px-6 lg:px-0 w-full md:max-w-[1124px] flex flex-col items-center gap-12">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-4">
            Here are the products you have marked as your favourites.
          </p>
        </div>
